...
GAMEROOT="/usr/home/definitly/.local/share/Steam/steamapps/common/Half-Life"
 ...
 doas   mv /compat/linux/usr/lib/libpulse.so.0  /compat/linux/usr/lib/libpulse.so.0.bak
...
doas mv /compat/linux/usr/lib/libpulse.so.0.bak   /compat/linux/usr/lib/libpulse.so.0
